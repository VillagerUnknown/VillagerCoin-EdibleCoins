...
public class EdibleCoinItems {
	...
	static {
		...
		HALF_EATEN_EDIBLE_COPPER_COIN = EdibleCoinFeature.registerEdibleCoinItem( Villagercoin.MOD_ID, "half_eaten_edible_copper_" + CoinFeature.COIN_STRING, Foods.POTATO, CoinFeature.COPPER_RARITY, 0, 1, EdibleCoinFeature.IRON_DROP_CHANCE, 1, 1, 1, StructuresIncludeCoinsFeature.COPPER_LOOT_TABLES );
		POISONOUS_EDIBLE_COPPER_COIN = EdibleCoinFeature.registerEdibleCoinItem( Villagercoin.MOD_ID, "poisonous_edible_copper_" + CoinFeature.COIN_STRING, Foods.POISONOUS_POTATO, CoinFeature.COPPER_RARITY, 0, 1, EdibleCoinFeature.GOLD_DROP_CHANCE, 1, 1, 1, StructuresIncludeCoinsFeature.COPPER_LOOT_TABLES, List.of(StewEffects.POISON) );
