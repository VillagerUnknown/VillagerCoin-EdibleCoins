...
public class EdibleCoinItems {
	...
	static {
		...
		POISONOUS_EDIBLE_COPPER_COIN = EdibleCoinFeature.registerEdibleCoinItem( Villagercoin.MOD_ID, "poisonous_edible_copper_" + CoinFeature.COIN_STRING, FoodComponents.POISONOUS_POTATO, CoinFeature.COPPER_RARITY, 0, 1, EdibleCoinFeature.GOLD_DROP_CHANCE, 1, 1, 1, StructuresIncludeCoinsFeature.COPPER_LOOT_TABLES, List.of(StewEffects.POISON) );
